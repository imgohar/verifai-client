...
const VideoKYC = () => {
    let testKey = process.env.REACT_APP_PROD_VIDEO_KYC_TEST_KEY;
    let liveKey = process.env.REACT_APP_PROD_VIDEO_KYC_LIVE_KEY;
    ...
    const [value, setValue] = useState(
        'https://production.sahal.ai/api/v1/video-kyc/conferences'
    );
    ...
    const onReset = () => {
        ...
        setShowLink(false);
        setLink('');
        setValue(`https://production.sahal.ai/api/v1/video-kyc/conferences`);
    };
