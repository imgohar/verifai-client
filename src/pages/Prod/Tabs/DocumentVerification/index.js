...
const DocumentVerification = () => {
    let testKey = process.env.REACT_APP_PROD_DOCUMENT_VERIFICATION_TEST_KEY;
    let liveKey = process.env.REACT_APP_PROD_DOCUMENT_VERIFICATION_LIVE_KEY;
    const [value, setValue] = useState(
        'https://production.sahal.ai/api/v1/document-verification/process'
    );
