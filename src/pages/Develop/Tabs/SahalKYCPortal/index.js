...
const SahalKYCPortal = () => {
    let testKey = process.env.REACT_APP_DEVELOP_SAHAL_KYC_PORTAL_TEST_KEY;
    let liveKey = process.env.REACT_APP_DEVELOP_SAHAL_KYC_PORTAL_LIVE_KEY;

    const [value, setValue] = useState(
        'https://develop.sahal.ai/api/v1/full-kyc/verification-url'
    );
    ...
    const onReset = () => {
        ...
        setShowLink(false);
        setLink('');
        setValue(`https://develop.sahal.ai/api/v1/full-kyc/verification-url`);
    };
