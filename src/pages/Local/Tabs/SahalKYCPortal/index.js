...
const SahalKYCPortal = () => {
    let testKey = process.env.REACT_APP_LOCAL_SAHAL_KYC_PORTAL_TEST_KEY;
    let liveKey = process.env.REACT_APP_LOCAL_SAHAL_KYC_PORTAL_LIVE_KEY;

    const [value, setValue] = useState(
        'https://sahal.dev-net.co:8084/api/v1/full-kyc/verification-url'
    );
