...
const DocumentVerification = () => {
    let testKey = process.env.REACT_APP_LOCAL_DOCUMENT_VERIFICATION_TEST_KEY;
    let liveKey = process.env.REACT_APP_LOCAL_DOCUMENT_VERIFICATION_LIVE_KEY;
    const [value, setValue] = useState(
        'https://sahal.dev-net.co:8084/api/v1/document-verification/process'
    );
