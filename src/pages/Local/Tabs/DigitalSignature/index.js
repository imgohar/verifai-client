...
const DigitalSignature = () => {
    let testKey = process.env.REACT_APP_LOCAL_DIGITAL_SIGNATURE_TEST_KEY;
    let liveKey = process.env.REACT_APP_LOCAL_DIGITAL_SIGNATURE_LIVE_KEY;
    const [value, setValue] = useState(
        'https://sahal.dev-net.co:8084/api/v1/digital-signature/face-register/frame-url?reference=USER_REFERENCE&digital_signature=USER_FULL_NAME'
    );
    ...
    const fullName = watch('fullName', 'USER_FULL_NAME');

    useEffect(() => {
        setValue(
            `https://sahal.dev-net.co:8084/api/v1/digital-signature/face-register/frame-url?reference=${userReference}&digital_signature=${fullName}`
        );
    ...
    const onSubmit = async (data) => {
        ...
        if (Object.values(data).every((field) => field.length > 0)) {
            ...
            await axios
                .get(
                    `https://sahal.dev-net.co:8084/api/v1/digital-signature/face-register/frame-url?reference=${data.userReference}&digital_signature=${data.fullName}`,
                    config
                )
                .then((res) => {
                    setShowLink(true);
    ...
    return (
        <div className="container">
            <h2 className="text-center">Digital Signature</h2>
