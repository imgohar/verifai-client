...
const VideoKYC = () => {
    let testKey = process.env.REACT_APP_LOCAL_VIDEO_KYC_TEST_KEY;
    let liveKey = process.env.REACT_APP_LOCAL_VIDEO_KYC_LIVE_KEY;
    ...
    const [value, setValue] = useState(
        'https://sahal.dev-net.co:8084/api/v1/video-kyc/conferences'
    );
    ...
    const onReset = () => {
        ...
        setShowLink(false);
        setLink('');
        setValue(`https://sahal.dev-net.co:8084/api/v1/video-kyc/conferences`);
    };
