...
const FacialBiometricKYC = () => {
    let testKey = process.env.REACT_APP_DEMO_FACIAL_BIOMETRIC_KYC_TEST_KEY;
    let liveKey = process.env.REACT_APP_DEMO_FACIAL_BIOMETRIC_KYC_LIVE_KEY;
    const [value, setValue] = useState(
        'https://demo.sahal.ai/api/v1/face-kyc/face-register/frame-url?reference=USER_REFERENCE'
    );
    ...
    useEffect(() => {
        setValue(
            `https://demo.sahal.ai/api/v1/face-kyc/face-register/frame-url?reference=${userReference}`
        );
