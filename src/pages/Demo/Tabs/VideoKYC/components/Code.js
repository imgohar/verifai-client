...
const Code = ({ value, link, token, body }) => {
...
curl -X GET ${value} -H "Accept: */*" -H "Authorization: Bearer ${token} -d "${JSON.stringify(
                body
            )}"
...
String data = "${JSON.stringify(body)}";
