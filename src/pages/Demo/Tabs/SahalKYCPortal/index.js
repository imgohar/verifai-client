...
const SahalKYCPortal = () => {
    let testKey = process.env.REACT_APP_DEMO_SAHAL_KYC_PORTAL_TEST_KEY;
    let liveKey = process.env.REACT_APP_DEMO_SAHAL_KYC_PORTAL_LIVE_KEY;
    ...
    const onReset = () => {
        ...
        setShowLink(false);
        setLink('');
        setValue(`https://demo.sahal.ai/api/v1/full-kyc/verification-url`);
    };
